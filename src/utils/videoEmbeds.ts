 ...
 */
export function initLiteYoutubeComponents(): void {
  document.addEventListener('liteYoutubeIframeLoaded', ((e: CustomEvent<{ videoId: string }>) => {
 ...
 */
export function pauseAllYoutubeVideos(): void {
